...
class TestEventScraper():
    ...
    test_fight_2 = {
        ...
        "Accolades": [
            {
            "Type": "Belt",
            "Name": "UFC Light Heavyweight Title"
            }
        ],
        "Referee": {
            "RefereeId": 31,
    ...
    def test_get_fighters_stats(self):
        ...
        actual = self.test_event.card_segments[0].fights[0].fighters_stats[0].__dict__
    ...
    def test_get_weight_class_obj_fight_1(self):
        ...
        actual = self.test_event_scraper._get_weight_class_obj(self.test_fight_1).__dict__
    ...
    def test_get_weight_class_obj_fight_2(self):
        ...
        actual = self.test_event_scraper._get_weight_class_obj(self.test_fight_2).__dict__
    ...
    def test_get_accolades_obj_fight_2(self):
        expected = Accolade(
            description="UFC Light Heavyweight Title",
            type="Belt"
        )
    ...
    def test_get_card_segments_names(self):
        ...
        for i, name in enumerate(expected):
            assert actual[i].segment_name == name
    
    def test_get_card_segments_start_times(self):
        expected = ["2022-12-11T03:00Z", "2022-12-11T01:00Z", "2022-12-10T23:30Z"]
        actual = self.test_event.card_segments
        
        for i, start_time in enumerate(expected):
            assert actual[i].start_time == _convert_date(start_time)
            
    def test_get_card_segments_broadcasters(self):
        expected = ["PPV", "ESPN 2", "UFC Fight Pass"]
        actual = self.test_event.card_segments
        
        for i, broadcaster in enumerate(expected):
            assert actual[i].broadcaster == broadcaster